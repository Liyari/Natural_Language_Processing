...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['filter-category'])) {
...
// Fetch active items
$query = "SELECT inventory_pack_id, name, category, price, weight, minquantity FROM inventory_pack WHERE active_status='Active'";
$results = mysqli_query($conn, $query);
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <main class="main">
            <header class="header">
                ...
                <div class="controls">
                    ...
                    <button class="btn btn-primary" id="add-new-dish-btn">New Dish</button>
                </div>
            </header>
