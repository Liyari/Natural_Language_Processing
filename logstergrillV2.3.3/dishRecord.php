...
if (isset($_GET['dish'])) {
    ...
    // Fetch daily records with sorting
    $recordQuery = "SELECT * FROM inventory_daily_record WHERE inventory_pack_id = '$dish_id' ORDER BY $sort_by $sort_order";
                                ...
                                <?php while ($record = mysqli_fetch_assoc($recordResults)): ?>
                                    <tr>
                                        ...
                                        <td>     
                                            ...
                                            <button class="rec-delete-btn" data-id="<?php echo $dish_id; ?>" data-date="<?php echo $record['date']; ?>"><i class="fas fa-trash"></i></button>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            </tbody>
